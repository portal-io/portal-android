...
public class BannerImgLoopUIAdapter extends BaseUIAdapter<BannerImgLoopUIAdapter.BannerImgLoopViewHolder, BannerImgLoopViewUIViewModel> implements ImageloaderUser, VisibleSwitcher {
    ...
    public BannerImgLoopViewHolder onCreateViewHolder(ViewGroup parent, int type) {
        return new BannerImgLoopViewHolder(getLayoutInfalterFormParent(parent).inflate(R.layout.item_discovery_banner_layout, parent, false));
    }
    ...
    @Override
    public void onBindViewHolder(final BannerImgLoopViewHolder UIViewHolder, BannerImgLoopViewUIViewModel uiViewModel, int position) {
            ...
            UIViewHolder.viewBanner
                    ...
                    .setBannerListener(new BannerAdapter.BannerListener() {
                        ...
                        public void onBannerItemClick(BannerViewHolder bannerViewHolder, int i) {
                            BannerImageViewHodler holder = (BannerImageViewHodler) bannerViewHolder;
    ...
    public class BannerImageAdapter extends BannerAdapter<BannerImgViewUIViewModel, BannerImageViewHodler> {
        ImageRequest.RequestManager requestManager;

        List<BannerImageViewHodler> bindedViewholders = new ArrayList<>();
        ...
        @Override
        public BannerImageViewHodler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            return new BannerImageViewHodler(view);
        }

        @Override
        public void onRecycleViewHolder(@NonNull BannerImageViewHodler holder) {
        ...
        @Override
        protected void onBindViewHolder(@NonNull BannerImageViewHodler bannerViewHolder, BannerImgViewUIViewModel bannerImgViewUIViewModel, int i) {
            ...
            bannerViewHolder.tv_title.setText(bannerImgViewUIViewModel.getName());
        ...
        public void loadImages() {
            for (BannerImageViewHodler viewHodler : bindedViewholders) {
    ...
    public static class BannerImageViewHodler extends BannerViewHolder implements ClickableUIViewHolder {
        ...
        public BannerImageViewHodler(View view) {
            ...
            tv_title = (TextView) view.findViewById(R.id.banner_title);
        }
