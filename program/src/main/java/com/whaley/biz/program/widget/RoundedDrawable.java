...
public class RoundedDrawable extends Drawable {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof RoundedDrawable) {
                ...
                // loop through layers toUser and change toUser RoundedDrawables if possible
                for (int i = 0; i < num; i++) {
            ...
            // try toUser get a bitmap from the drawable and
    ...
    public static Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            Log.e(e, "drawableToBitmap");
            Log.w(TAG, "Failed toUser create bitmap from drawable!");
            bitmap = null;
        }
        return bitmap;
    }
