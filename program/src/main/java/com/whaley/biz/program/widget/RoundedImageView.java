...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (index >= 0) {
            ...
            // default scaletype toUser FIT_CENTER
        ...
        if (cornerRadius < 0) {
            cornerRadius = getResources().getDimension(R.dimen.default_cornerRadius);
        }
        if (borderWidth < 0) {
    ...
    /**
     * Controls how the image should be resized or moved toUser match the size of
     * this ImageView.
     *
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.w(TAG, "Unable toUser find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    private void applyColorMod() {
        ...
        // not reset the mColorMod flag, since these filters need toUser be
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ...
            // loop through layers toUser and set drawable attrs
