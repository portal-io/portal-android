package com.whaley.biz.setting.widget.address.manager;
...
public class AssetsDatabaseManager {
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        if (databases.get(dbfile) != null) {
            ...
            SQLiteDatabase db = SQLiteDatabase.openDatabase(getDatabaseFile(dbfile), null, SQLiteDatabase.NO_LOCALIZED_COLLATORS);
            if (db != null) {
        ...
        SharedPreferences dbs = getContext().getSharedPreferences(AssetsDatabaseManager.class.toString(), 0);
    ...
    private String getDatabaseFilepath() {
        return String.format(databasepath, getContext().getApplicationInfo().packageName);
    }
    ...
    private boolean copyAssetsToFilesystem(String assetsSrc, String des) {
        ...
        boolean isCopyAssetsToFiles = false;
