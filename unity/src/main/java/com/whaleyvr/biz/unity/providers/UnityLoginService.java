...
@Route(path = "/unity/service/login")
public class UnityLoginService implements Executor<String> {

    @Override
    public void excute(String o, final Callback callback) {
        MessageControl.getInstance().sendEvent(HermesConstants.EVENT_SEND_LOGIN);
    }
